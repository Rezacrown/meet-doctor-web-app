    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @can('operational_access') --}}
                <li class=" nav-item"><a href="#"><i class="{{ request()->is('backsite/docter') || request()->is('backsite/docter/*') || request()->is('backsite/*/docter') || request()->is('backsite/*/docter/*') || request()->is('backsite/hospital_patient') || request()->is('backsite/hospital_patient/*') || request()->is('backsite/*/hospital_patient') || request()->is('backsite/*/hospital_patient/*') || request()->is('backsite/appointment') || request()->is('backsite/appointment/*') || request()->is('backsite/*/appointment') || request()->is('backsite/*/appointment/*') || request()->is('backsite/transaction') || request()->is('backsite/transaction/*') || request()->is('backsite/*/transaction') || request()->is('backsite/*/transaction/*') ? 'bx bx-hive bx-flashing' : 'bx bx-hive' }}"></i><span class="menu-title" data-i18n="Operational">Operational</span></a>
                    <ul class="menu-content">

                        {{-- @can('docter_access') --}}
                            <li class="{{ request()->is('backsite/docter') || request()->is('backsite/docter/*') || request()->is('backsite/*/docter') || request()->is('backsite/*/docter/*') ? 'active' : '' }} ">
                                <a class="menu-item" href="{{ route('backsite.docter.index') }}">
                                    <i></i><span>Docter</span>
                                </a>
                            </li>
                        {{-- @endcan --}}
